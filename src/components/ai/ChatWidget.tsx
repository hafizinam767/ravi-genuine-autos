  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      const botMessage: ChatMessage = {
        ...
        content:
          data.response ||
          'Sorry, I could not process your request. Please try again or contact us at Mehar Zulfeqar Ali 0320-0408917 / 0332-4131636.',
      };
    ...
    <>
      ...
      <AnimatePresence>
        {!showChat && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg hover:shadow-xl active:scale-95 transition-colors" style={{ backgroundColor: '#B91C1C' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#991B1B')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = '#B91C1C')}
      ...
      <AnimatePresence>
        {showChat && (
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b px-4 py-3" style={{ backgroundColor: '#B91C1C' }}>
            ...
            <div className="border-t bg-background px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  size="icon"
                  className="h-10 w-10 shrink-0 rounded-full disabled:opacity-50" style={{ backgroundColor: '#B91C1C' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#991B1B')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = '#B91C1C')}
