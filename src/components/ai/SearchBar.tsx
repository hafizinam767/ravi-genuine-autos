    ...
    <div ref={containerRef} className="relative w-full">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="w-full rounded-xl border-border bg-background pl-10 pr-20 py-2.5 text-sm shadow-sm focus-visible:ring-red-700"
        />
        <div className="absolute right-2 top-1/2 flex -translate-y-1/2 items-center gap-1">
          ...
          <Button
            ...
            size="sm"
            className="h-7 gap-1 rounded-lg px-2.5 text-xs font-medium text-white disabled:opacity-50" style={{ backgroundColor: '#B91C1C' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#991B1B')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = '#B91C1C')}
          >
          ...
          >
            ...
            {POPULAR_SEARCHES.map((term) => (
              <button
                ...
                className="flex w-full items-center gap-2 px-3 py-2 text-sm text-foreground hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors"
              >
            ...
            <div className="border-t px-3 py-2">
              <button
                ...
                className="flex w-full items-center gap-2 text-sm" style={{ color: '#B91C1C' }} onMouseEnter={(e) => (e.currentTarget.style.color = '#991B1B')} onMouseLeave={(e) => (e.currentTarget.style.color = '#B91C1C')}
              >
      ...
      <AnimatePresence>
        {showAIBadge && aiSuggestion && (
          ...
          >
            <div className="rounded-xl border border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950/30 p-3 shadow-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-0.5 text-xs text-red-700 dark:text-red-400">
                    ...
                    {aiSuggestion.category && (
                      <Badge
                        variant="secondary"
                        className="ml-1.5 bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300 text-[10px] px-1.5 py-0"
                      >
                        {aiSuggestion.category}
                      </Badge>
                    )}
                  ...
                  {aiSuggestion.condition && (
                    <Badge
                      variant="outline"
                      className="mt-1 border-red-300 text-red-700 dark:border-red-700 dark:text-red-400 text-[10px]"
                    >
                      {aiSuggestion.condition}
                    </Badge>
                  )}
                ...
                <Button
                  size="sm"
                  className="h-7 gap-1 rounded-lg px-2.5 text-xs font-medium text-white" style={{ backgroundColor: '#B91C1C' }} onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#991B1B')} onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = '#B91C1C')}
