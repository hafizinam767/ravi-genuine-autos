  ...
  return (
    <>
      <div className="mx-auto max-w-6xl py-6">
        {/* Back to Cart */}
        <button
          className="mb-6 flex items-center gap-2 text-sm text-muted-foreground hover:text-amber-600 transition-colors"
      ...
      <Dialog open={showSuccess} onOpenChange={setShowSuccess}>
        ...
        >
          ...
          <div className="rounded-lg bg-muted p-4 text-center">
            ...
            <p className="text-lg font-bold text-amber-600">{orderId}</p>
          </div>
          <Button
            className="w-full bg-amber-600 text-white hover:bg-amber-700"
            onClick={() => {
