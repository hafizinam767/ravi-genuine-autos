          ...
          {pages.map((p, i) =>
            typeof p === 'string' ? (
              ...
              <Button
                ...
                className={
                  p === page
                    ? 'text-white min-w-[36px]'
                    : 'min-w-[36px]'
                }
                style={p === page ? { backgroundColor: '#B91C1C' } : undefined}
                onMouseEnter={p === page ? (e) => (e.currentTarget.style.backgroundColor = '#991B1B') : undefined}
                onMouseLeave={p === page ? (e) => (e.currentTarget.style.backgroundColor = '#B91C1C') : undefined}
                onClick={() => setPage(p)}
                aria-label={`Page ${p}`}
