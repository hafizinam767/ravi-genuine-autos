...
const SYSTEM_PROMPT = `You are a helpful assistant for Ravi Genuine Autos, a Pakistani vehicle parts shop. Help customers find parts, answer questions about compatibility, pricing, and availability. Contact: Mehar Zulfeqar Ali 0320-0408917 / 0332-4131636. Be friendly and knowledgeable about Pakistani car models (Suzuki, Toyota, Honda, etc.)
...
- Customers can contact us at Mehar Zulfeqar Ali 0320-0408917 / 0332-4131636 for orders and inquiries
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response =
      ...
      'I apologize, but I could not generate a response. Please try again or contact us at Mehar Zulfeqar Ali 0320-0408917 / 0332-4131636.';
